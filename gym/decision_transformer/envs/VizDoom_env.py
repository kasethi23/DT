...
class DoomEnvironmentDisappear(object):
    ...
    def __init__(
        ...
        scenario="gym/decision_transformer/envs/basic.cfg",
        get_extra_obs=False, 
    ...
    def _gen_actions(self, game, no_backward_movement):
        ...
        elif buttons == [Button.TURN_LEFT, Button.TURN_RIGHT, Button.ATTACK]:
            if no_backward_movement:
                feasible_actions = [
    ...
    def make_action(self, action, human_play=False):
        ...
        # the agent skips frames and makes the same action for the skipped frames as the last action
        """
    ...
    def get_info(self):
        ...
        wandb.log({"Kill_count": wandb.plot.scatter( self.game.get_game_variable(GameVariable.KILLCOUNT))})
