...
def parse_a2c_args():
    ...
    paa('--scenario',           default='basic.cfg',    help='The scenario',  type=str)
    ...
    paa('--scenario_dir',       default='',           help='location of scenarios',  type=str)    
    paa('--test_scenario_dir',  default='',                        help='location of game scenarios',  type=str)    
    paa('--show_window',        default=True,                     help='Show the game window',  type=bool)
    ...
    paa('--num_actions',        default=3,                         help='size of action space', type=int)
